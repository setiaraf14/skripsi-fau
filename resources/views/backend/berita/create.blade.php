        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ url('backend/berita/store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-row">
                                <div class="form-group col-lg-6">
                                    <label for="judul_berita">Masukan Judul Kegiatan</label>
                                    <input type="text" name="judul_berita" class="form-control @error('judul_berita') ins-invalid @enderror"  value="{{ old('judul_berita')}}" required>
                                    @error('judul_berita')
                            ...
                            <div class="form-group col-lg-12">
                                ...
                                <textarea id="field" onkeyup="countChar(this)" class="form-control @error('alamat_berita') is-invalid @enderror" name="alamat_berita"  rows="3" required>{{ old('alamat_berita') }}</textarea>
                            </div>
