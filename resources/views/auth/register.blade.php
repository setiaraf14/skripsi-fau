                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6 d-flex justify-content-center">
                                <input id="password" type="password"
                                    ...
                                    required autocomplete="new-password"><a class="btn btn-info" onclick="lihatPass()">Lihat</i></a>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6 d-flex justify-content-center">
                                <input id="password-confirm" type="password" class="form-control"
                                    name="password_confirmation" required autocomplete="new-password"><a class="btn btn-info" onclick="lihatConfirmPass()">Lihat</i></a>
                            </div>
                        </div>
